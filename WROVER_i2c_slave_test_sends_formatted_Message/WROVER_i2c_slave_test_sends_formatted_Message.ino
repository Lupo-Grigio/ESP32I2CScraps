// Slave Test for my WROVER CAM module
...
void setup() 
{
  ...
  Wire.begin(SLAVE_ADDRESS,I2C_BUS1_SDA,I2C_BUS1_SCL,BUS_FREQ); // I2C bus 1 setup SLAVE
...
void loop() 
{
  ...
  Serial.printf("Status Bump Slave ID %i SCL %i SCA %i Freq %i LED %d is %s\n",SLAVE_ADDRESS,I2C_BUS1_SDA,I2C_BUS1_SCL,BUS_FREQ,LED_BUILTIN,digitalRead(LED_BUILTIN) ? "LOW" : "HIGH" );
}
...
// Write an Eye change message to primary M4SK
void WriteToPrimaryEventVerbose()
{
  Serial.print("Slave Requested to WRITE on I2C bus : ");
  
  //String Msg = String(" Testing TeStInG 1256 \n");
//String Msg = String( " Face found = 1 X = 002 Y = 030 Blink = 400 Pupil = 5000 W = 60 H = 6 W_Min = 8 H_Min = 009 W_Max = 010 H_Max = 110 \n");
  String Msg = String( " Face found = 1 X = 002 123456 \n"); // SUCCEED
  //String Msg = String( " Face found = 1 X = 002 1234567 \n"); // FAIL
